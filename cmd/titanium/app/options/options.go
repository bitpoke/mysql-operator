...
func (s *TitaniumControllerOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&s.Namespace, "namespace", defaultNamespace, ""+
		"Namespace to monitor resources within. If not specified, default namespace will be watched")

	fs.BoolVar(&s.LeaderElect, "leader-elect", true, ""+
		"If true, titanium-controller will perform leader election between instances to ensure no more "+
		"than one instance of titanium-controller operates at a time")
