...
function dind::wait-for-ready {
  ...
  # ensure current continaner is in the same network with cluster
  dind::step "Ensure ${HOSTNAME} is in kubeadm-dind-net..."
  docker network connect kubeadm-dind-net $HOSTNAME || true
