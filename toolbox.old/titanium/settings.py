...
# utility user
UTILITY_USER = os.getenv('TITANIUM_UTILITY_USER', '')
UTILITY_PASSWORD = os.getenv('TITANIUM_UTILITY_PASSWORD', '')
UTILITY_SCHEMA_ACCESS = 'mysql'
#UTILITY_PRIVILEGES = 'CREATE,DROP,LOCK TABLES,CREATE USER,GRANT'
UTILITY_PRIVILEGES = 'SELECT,INSERT,UPDATE,DELETE,CREATE,DROP,RELOAD,SHUTDOWN,PROCESS,FILE,GRANT,REFERENCES,INDEX,ALTER,SHOW DATABASES,SUPER,CREATE TEMPORARY TABLES,LOCK TABLES,EXECUTE,REPLICATION SLAVE,REPLICATION CLIENT,CREATE VIEW,SHOW VIEW,CREATE ROUTINE,ALTER ROUTINE,CREATE USER,EVENT,TRIGGER,CREATE TABLESPACE'
