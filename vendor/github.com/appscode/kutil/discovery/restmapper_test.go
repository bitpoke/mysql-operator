...
import (
	...
	// admission "k8s.io/v1beta1/admission/v1beta1"
	// admissionregistration "k8s.io/v1beta1/admissionregistration/v1beta1"
	apps "k8s.io/api/apps/v1"
	// authentication "k8s.io/v1beta1/authentication/v1"
	// authorization "k8s.io/v1beta1/authorization/v1"
	...
	// imagepolicy "k8s.io/v1beta1/imagepolicy/v1alpha1"
	networking "k8s.io/api/networking/v1"
	policy "k8s.io/api/policy/v1beta1"
	rbac "k8s.io/api/rbac/v1"
	// scheduling "k8s.io/v1beta1/scheduling/v1alpha1"
