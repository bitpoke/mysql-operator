...
// +kubebuilder:rbac:groups=mysql.bitpoke.io,resources=mysqlclusters;mysqlclusters/status;mysqlclusters/finalizers,verbs=get;list;watch;create;update;patch;delete
