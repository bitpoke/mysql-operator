...
func TestClusterController(t *testing.T) {
	...
	RunSpecs(t, "Test clusters controller")
}

var _ = Describe("Test cluster controller", func() {
	var (
	...
	BeforeEach(func() {
		...
		controller = newClusterController(stop, client, myClient, crdClient, rec)
...
func newClusterController(stop chan struct{}, client *fake.Clientset,
